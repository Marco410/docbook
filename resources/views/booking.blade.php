					...
					<div class="row">
						<div class="col-12">
								...
								<div class="card-body">
									<div class="booking-doc-info">
										<a href="doctor-profile" class="booking-doc-img">
											<img src="/storage/{{ $dr->foto }}" alt="User Image">
										</a>
										<div class="booking-info">
											<h4><a href="dr-profile">Dr. {{ $dr->nombre }} {{ $dr->apellido_p }} {{ $dr->apellido_m }}</a></h4>
											<div class="rating">
											...
											<p class="text-muted mb-0"><i class="fas fa-map-marker-alt"></i> {{ $dr->ciudad }}, {{ $dr->estado }} México</p>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="submit-section proceed-btn text-right">
								<a href="{{ route('verificar') }}" class="btn btn-primary submit-btn">Proceder a Pagar</a>
							</div>
							<!-- /Submit Section -->
