							...
							<div class="set-category">
								<div class="d-flex align-items-center">
									...
									<div class="info-holder">
										...
										<a href="booking" class="book-now">Book Now <i class="fas fa-long-arrow-alt-right"></i></a>
									</div>
								</div>
								<h1>01</h1>
							</div>
							...
							<div class="browse-slider slider">
								<div class="profile-widget browse-widget">
									...
									<div class="overlay">
										...
										<h3>UROLOGY</h3>
										<a href="doctor-profile" class="arrows"><i class="fas fa-long-arrow-alt-right"></i></a>
									</div>
								</div>
								<div class="profile-widget browse-widget">
									<img src="assets/img/icons/browse-01.jpg" alt="" />
			...
			<section class="book-doctor">
				<div class="container">					
								...
								<div class="profile-widget">
									...
									<div class="pro-content">
										...
										<div class="provider-info">
											<h3><a href="doctor-profile">Dr. Pullman</a></h3>
											<div>
												<h5>PSICOLOGIST </h5>
												<div class="rating">
					...
					<div class="row justify-content-center mt-4">
						<a href="doctor-profile" class="view-btn">View More</a>
					</div>
				</div>
			</section>
			<!-- /Book Doctors-->
			...
			<section class="blogs-section">
				<div class="container">			
							...
							<div class="blog-wrapper">
								...
								<div class="wrap-content">
									...
									<div class="wrap-content-body">
										...
										<a href="blog-details" class="read-txt">Read More</a>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="row justify-content-center">
						<a href="blog-details" class="view-btn">View More</a>
					</div>		
				</div>
			</section>
			<!-- /Blog Section-->
