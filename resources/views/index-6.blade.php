...
<!-- Home Banner -->
										...
										<div class="row">
											<div class="col-md-6">
												<div class="form-group">
													<button class="btn btn-type" >PRESENCIAL</button>
													<button class="btn btn-type" >EN LINEA</button>
												</div>
											</div>
											...
											<div class="col-md-6">
												<div class="form-group">
													...
													<div class="form-custom">
														<input type="text" class="form-control" value="" placeholder="Ej. Ginecólogo">
											...
											<div class="col-md-6">
												<div class="form-group">
													<div class="form-custom">
														<input type="text" class="form-control" value="" placeholder="Ej. Villahermosa">
                ...
                <div class="container" >
                    <div class="row" >
                        <div class="col-md-12 text-center">
							<div class="section-headin bg-area">
								<h2>¿CÓMO FUNCIONA?</h2>
							</div>
						</div>
                    ...
                    <div class="row" >
                        <div class="col-md-12 text-center" >
                            <div class="section-headin ">
								...
								<h4>Descubra los mejores médicos.</h4>
							</div>
                        </div>
                    </div>
	...
	<!-- Clinic and Specialities -->
            ...
            <section class="eres" >
                <div class="row" >
                <div class="col-md-6 bg-doctor">
                    <div class="row" >
                        <div class="col-md-4 text-center" >
                            <img  width="200px" src="assets/img/icons/doctor.png" alt="" class="img-fluid">
                        </div>
                        <div class="col-md-8 text-center" >
                            <h2>¿ERES DOCTOR?</h2>
                            <h4>Cree su perfil gratuito y deje que los pacientes le encuentren.</h4><br>
                            <button class="btn btn-register" >REGISTRATE</button>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 bg-pacient" >
                    <div class="row" >
                        <div class="col-md-4 text-center" >
                            <img width="200px" src="assets/img/icons/pacient.png" alt="" class="img-fluid">
                        </div>
                        <div class="col-md-8 text-center" >
                            <h2>¿ERES PACIENTE?</h2>
                            <h4>Cree su perfil gratuito y encuentre el mejor especialista.</h4><br>
                            <button class="btn btn-register" >REGISTRATE</button>
                        </div>
                    </div>
                </div>
			...
			<section class="book-section">
				<div class="container">
					...
					<div class="section-header-three text-center">
						<h2>NUESTROS ESPECIALISTAS 5 ESTRELLAS</h2>
						...
						<div class="col-lg-3 col-md-6">
							<div class="book-best-doctors">
								<div class="book-header">
									<a href="doctor-profile"><img src="storage/{{ $doctor->foto }}" alt="" class="img-fluid"></a>
								...
								<div class="doctors-body">
									<div class="inner-section">
										<span class="float-left">{{ $doctor->especialidad()->get()[0]->nombre }}</span>
										...
										<a href="doctor-profile"><h4>Dr. {{ $doctor->nombre }} {{ $doctor->apellido_p }} {{ $doctor->apellido_m }}</h4></a>
										...
										<div class="col-6">
											<div class="d-flex align-items-center">
												...
												<a href="javascript:void(0);">
													...
													<span class="data-info">{{ $doctor->clinicas()->get()[0]->ciudad_consultorio }} {{ $doctor->clinicas()->get()[0]->colonia_consultorio }} {{ $doctor->clinicas()->get()[0]->estado_consultorio }}, México</span>
												</a>
											</div>
										</div>
										<div class="col-6">
											<div class="d-flex align-items-center">
												...
												<a href="javascript:void(0);">
													...
													<span class="data-info">{{ $doctor->telefono }}</span>
												</a>
											</div>
										</div>
										<div class="col-6">
											<div class="d-flex align-items-center">
												...
												<a href="javascript:void(0);">
													...
													<span class="data-info">{{ $doctor->primera }}</span><br>
													<span class="data-info txt-primary"><small>SEGUIMIENTO</small></span><br>
													<span class="data-info">{{ $doctor->seguimiento }}</span>
												</a>
											</div>
										</div>
										<div class="col-6">
											...
											<div class="d-flex align-items-center">
												...
												<a href="javascript:void(0);">
													...
													<span class="data-info">/{{ $doctor->nombre }}-{{ $doctor->apellido_p }}</span>
												</a>
											</div>
										</div>
									</div>
									<div class="row row-sm align-items-center p-3">
										<div class="col-6">
											<a href="{{ route('citas',$doctor->id) }}" class="btn book-btn" tabindex="0">Pedir Cita</a>
										</div>
										<div class="col-6">
											<a href="tel:{{ $doctor->telefono }}" class="btn btn-warning text-white" style="border-radius: 30px;" tabindex="0">  LLamar </a>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="our-doctors-card">
								...
								<div class="doctors-body">
									...
									<div class="location d-flex">
										...
										<p class="ml-auto"><i class="fas fa-user-md"></i> 450 Consultations</p>
									</div>
