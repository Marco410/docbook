		...
		<div class="row">
			...
			<div class="col-md-8 col-lg-9 col-xl-9">
			 ...
			 @else
				...
				if($diff->days > 0 ){
				?>
				<input type="hidden" value="{{ $openCaja->id }}" id="check_caja_id" >
				...
				<input type="hidden" value="{{ $openCaja->apertura }}" id="check_caja_apertura" >
					<script>
					verificar_caja();
					</script>
				<?php
						...
						<div class="card">
							...
							<div class="row">
								...
								<div class="form-group col-sm-4">
									...
									<input readonly type="text" name="salidas_efectivo" class="form-control" id="salidas_efectivo" value="{{ $efectivoS }}" >
								</div>
								<div class="form-group col-sm-4">
									<label><i class="fas fa-credit-card text-info" ></i> Tarjeta Salidas <span class="text-danger">*</span></label>
									<input  readonly type="text" name="salidas_tarjeta" class="form-control" id="salidas_tarjeta" value="{{ $tarjetaS }}" >
								</div>
								<div class="form-group col-sm-4">
									<label><i class="fas fa-exchange-alt text-info" ></i> Transferencia Salidas <span class="text-danger">*</span></label>
									<input readonly type="text" name="salidas_transferencia" class="form-control" id="salidas_transferencia" value="{{ $transferenciaS }}">
								</div>
							</div>
							<div class="row">
