							...
							<div class="row form-row">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<input type="text" name="seguro_social" class="form-control" value="{{ old("seguro_social") }}">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
								...
								<div class="col-md-6">
									<div class="form-group">
										<label>Empleo </label>
										<input type="text" name="empleo" class="form-control" value="{{ old("empleo") }}">
									</div>
								</div>
							...
							<div class="row">
								...
								<div class="col-sm-6">
									<div class="form-group mb-3">
										...
										<input type="text" name="nombre_familiar" class="form-control" value="{{ old("nombre_familiar") }}">
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group mb-3">
										<label>Teléfono </label>
										<input type="text" name="telefono_familiar" class="form-control" value="{{ old("telefono_familiar") }}">
									</div>
								</div>
