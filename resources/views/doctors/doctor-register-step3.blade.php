										...
										<form method="post" enctype="multipart/form-data" action="{{ url('/registro-paso3')}}">
											...
											<div class="form-group row" >
												...
												<div class="col-sm-12 form-group mt-3">
													...
													<input required type="number" name="primera" id="primera" class="form-control" placeholder="Ejem: 700" value="{{ old('primera') }}" />
												</div>

												<div class="col-sm-12 form-group mt-3">
													<label>Precio 2da Consulta $ (MXN)<span class="text-danger">*</span></label>
													<input required type="number" name="seguimiento" min="1" id="seguimiento" placeholder="Ejem: 500" class="form-control" value="{{ old('seguimiento') }}" />
												</div>
