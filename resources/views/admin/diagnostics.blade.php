                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div role="alert" class="alert alert-success alert-dismissible fade show"  ><strong>Éxito: </strong>Diagnóstico añadido {{ $d->descripcion_4 ?? '' }}</div>
                                @else

                                @endif
                                <form method="POST" action="{{ route('save-diagnostic') }}">
                                    {{ csrf_field() }}
                                    <div class="row">
                                        <div class="col-md-4">
