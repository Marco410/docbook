							...
							<div class="profile-header">
								<div class="row align-items-center">
									<div class="col-auto profile-image">
										<a href="#">
											<img class="rounded-circle" alt="Imagen de usuario" src="/storage/{{ $doctor->foto }}">
										</a>
									</div>
									<div class="col ml-md-n2 profile-user-info">
										<h4 class="user-name mb-0">{{ $doctor->nombre }} {{ $doctor->apellido_p }} {{ $doctor->apellido_m}}</h4>
										<h6 class="text-muted">{{ $doctor->email }}</h6>
										<div class="user-Location"><i class="fa fa-map-marker"></i> {{ $doctor->ciudad }}, {{ $doctor->estado }} México</div>
											...
											<div class="card">
												<div class="card-body">
													...
													<div class="row">
														...
														<p class="col-sm-10">{{ $doctor->nombre }} {{ $doctor->apellido_p }} {{ $doctor->apellido_m}}</p>
													</div>
													<div class="row">
													...
													<div class="row">
														...
														<p class="col-sm-10">{{ $doctor->telefono }}</p>
													</div>
													<div class="row">
														<p class="col-sm-2 text-muted text-sm-right mb-0">Dirección</p>
														<p class="col-sm-10 mb-0">{{ $doctor->direccion }}<br>
															{{ $doctor->direccion2 }}<br>
															{{ $doctor->cp }},<br>
															{{ $doctor->ciudad }}, {{ $doctor->estado }}.</p>
													</div>
												</div>
											</div>
																...
																<div class="row form-row">
																	<div class="col-12 col-sm-4">
																		<div class="form-group">
																			<label>Nombre</label>
																			<input type="text" class="form-control" value="{{ $doctor->nombre }}">
																		</div>
																	</div>
																	<div class="col-12 col-sm-4">
																		<div class="form-group">
																			<label>Apellido Paterno</label>
																			<input type="text"  class="form-control" value="{{ $doctor->apellido_p }}">
																		</div>
																	</div>
																	<div class="col-12 col-sm-4">
																		<div class="form-group">
																			<label>Apellido Materno</label>
																			<input type="text"  class="form-control" value="{{ $doctor->apellido_m }}">
																		</div>
																	</div>
																	...
																	<div class="col-12 col-sm-6">
																		<div class="form-group">
																			...
																			<input type="text" value="{{ $doctor->telefono }}" class="form-control">
																		</div>
																	</div>
																	<div class="col-12">
																	...
																	<div class="col-12">
																		...
																		<label>Direccion</label>
																			<input type="text" class="form-control" value="{{ $doctor->direccion }}, {{ $doctor->direccion2 }}">
																		</div>
																	</div>
																	<div class="col-12 col-sm-6">
																		<div class="form-group">
																			<label>Ciudad</label>
																			<input type="text" class="form-control" value="{{ $doctor->ciudad }}">
																		</div>
																	</div>
																	<div class="col-12 col-sm-6">
																		<div class="form-group">
																			<label>Estado</label>
																			<input type="text" class="form-control" value="{{ $doctor->estado }}">
																		</div>
																	</div>
																	<div class="col-12 col-sm-6">
																		<div class="form-group">
																			<label>Código Postal</label>
																			<input type="text" class="form-control" value="{{ $doctor->cp }}">
																		</div>
																	</div>
																	<div class="col-12 col-sm-6">
																		<div class="form-group">
