				...
				<div class="container-fluid">
					<div class="row align-items-center">
						<div class="col-md-12 col-12">
							...
							<h2 class="breadcrumb-title">Citas</h2>
						</div>
					</div>
				</div>
			</div>
						...
						<div class="col-12">
								...
								<div class="card-body">
									<div class="booking-doc-info">
										<a href="doctor-profile" class="booking-doc-img">
											<img src="/storage/<?php echo e($dr->foto); ?>" alt="User Image">
										</a>
										<div class="booking-info">
											<h4><a href="dr-profile">Dr. <?php echo e($dr->nombre); ?> <?php echo e($dr->apellido_p); ?> <?php echo e($dr->apellido_m); ?></a></h4>
											<div class="rating">
											...
											<p class="text-muted mb-0"><i class="fas fa-map-marker-alt"></i> <?php echo e($dr->ciudad); ?>, <?php echo e($dr->estado); ?> México</p>
										</div>
									</div>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-12 col-sm-4 col-md-6">
									<h3 class="mb-1"><?php echo e(date("d M Y")); ?></h3>
							...
							<div class="submit-section proceed-btn text-right">
								<a href="<?php echo e(route('verificar')); ?>" class="btn btn-primary submit-btn">Proceder a Pagar</a>
							</div>
							<!-- /Submit Section -->
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\pixelar_doc\laravel-files\template\resources\views/booking.blade.php ENDPATH**/ ?>