			...
			<li class="nav-item dropdown has-arrow logged-item">
				...
				<div class="dropdown-menu dropdown-menu-right">
					<div class="user-header">
						...
						<div class="user-text">
							<h6><?php echo e(Auth::user()->nombre); ?> <?php echo e(Auth::user()->apellido_p); ?></h6>
							<p class="text-muted mb-0"><?php echo e(Auth::user()->getRoleNames()[0]); ?></p>
						</div>
					</div>
					<a class="dropdown-item" href=" <?php if(Auth::user()->getRoleNames()[0]  === "Paciente"): ?> <?php echo e(route('paciente-inicio')); ?> <?php else: ?> <?php echo e(route('doctor-inicio')); ?> <?php endif; ?>">Inicio</a>
					<a class="dropdown-item" href="doctor-profile-settings">Perfil</a>
					<a class="dropdown-item" href="<?php echo e(route('logout')); ?>"
								onclick="event.preventDefault();
											document.getElementById('logout-form').submit();">
								<?php echo e(__('Cerrar Sesiónsss')); ?>
...
<!-- /Header --><?php /**PATH D:\xampp\htdocs\pixelar_doc\laravel-files\template\resources\views/layout/partials/header.blade.php ENDPATH**/ ?>