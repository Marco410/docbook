			...
			<div class="dropdown-menu">
				<div class="user-header">
					<div class="avatar avatar-sm">
						<img src="/assets_admin/img/icons/male.png" alt="User Image" class="avatar-img rounded-circle">
					</div>
					<?php if(auth()->guard()->check()): ?>
					<div class="user-text">
						<h6><?php echo e(Auth::user()->nombre); ?></h6>
						<p class="text-muted mb-0">Rol: <?php echo e(Auth::user()->getRoleNames()[0]); ?></p>
					</div>
					<?php endif; ?>
				</div>
...
<!-- /Header --><?php /**PATH D:\xampp\htdocs\pixelar_doc\laravel-files\template\resources\views/layout/partials/header_admin.blade.php ENDPATH**/ ?>