					...
					<div class="card-body">
						<div class="table-responsive">
							<table class="datatable table table-hover table-center mb-0">
								...
								<tbody>
									<?php $__currentLoopData = $especialidades; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $espe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<tr>
										<td>#SP<?php echo e($espe->id); ?></td>
										
										<td>
											<h2 class="table-avatar">
												<a href="profile" class="avatar avatar-sm mr-2">
													<img class="avatar-img" src="../storage/<?php echo e($espe->imagen); ?>" alt="<?php echo e($espe->nombre); ?>">
												</a>
												<a href="profile"><?php echo e($espe->nombre); ?></a>
											</h2>
										</td>
									
										<td class="text-right">
											<div class="actions">
												<a class="btn btn-sm bg-warning-light btn-editar" data-toggle="modal" data-id="<?php echo e($espe->id); ?>" data-value="<?php echo e($espe->nombre); ?>" href="#edit_specialities_details">
													<i class="fe fe-pencil"></i> Editar
												</a>
												<a  data-toggle="modal" href="#delete_modal" class="btn btn-sm bg-danger-light btn-delete" data-id="<?php echo e($espe->id); ?>">
...
<div class="modal fade" id="edit_specialities_details" aria-hidden="true" role="dialog">
	<div class="modal-dialog modal-dialog-centered" role="document" >
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" enctype="multipart/form-data" action="<?php echo e(url('/admin/editar-especialidad')); ?>" class="needs-validation" novalidate >
					<?php echo e(csrf_field()); ?>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-content p-2">
					...
					<form method="post"  action="<?php echo e(url('/admin/eliminar-especialidad')); ?>" >
						<?php echo e(csrf_field()); ?>
...
<?php echo $__env->make('layout.mainlayout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\pixelar_doc\laravel-files\template\resources\views/admin/specialities.blade.php ENDPATH**/ ?>