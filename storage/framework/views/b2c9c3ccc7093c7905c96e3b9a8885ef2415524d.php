						...
						<div class="col-md-12 col-12">
							<nav aria-label="breadcrumb" class="page-breadcrumb">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Panel de Inicio</li>
								</ol>
							</nav>
							<h2 class="breadcrumb-title">Panel de Inicio</h2>
						</div>
					</div>
				</div>
			</div>
								...
								<div class="widget-profile pro-widget-content">
									<div class="profile-info-widget">
										...
										<div class="profile-det-info">
											<h3><?php echo e(Auth::user()->nombre); ?> <?php echo e(Auth::user()->apellido_p); ?> <?php echo e(Auth::user()->apellido_m); ?></h3>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\pixelar_doc\laravel-files\template\resources\views/pacients/patient-dashboard.blade.php ENDPATH**/ ?>