	...
	<footer class="footer">
					...
					<div class="container-fluid">
						<div class="row">
                            ...
                            <div class="col-md-3">
								<!-- Footer Widget -->
								<div class="footer-widget footer-menu">
									<h2 class="footer-title">Para los pacientes</h2>
									<ul>
										<li><a href="#">Especialistas</a></li>
										<li><a href="#">Clínicas</a></li>
										<li><a href="#">Preguna al Experto</a></li>
							...
							<div class="col-md-3">
								...
								<!-- Footer Widget -->
								<div class="footer-widget footer-menu">
									<h2 class="footer-title">Para Profesionales</h2>
									<ul>
						...
						<div class="row">
							<div class="col-md-6 col-lg-6">
								<div class="copyright-text">
									<p class="mb-0">&copy; 2020 <span>DocBook</span>. Todos los Derechos Reservados.</p>
								</div>
							</div>
							<div class="col-md-6 col-lg-6">
			...
			<!-- /Footer --><?php /**PATH D:\xampp\htdocs\pixelar_doc\laravel-files\template\resources\views/layout/partials/footer.blade.php ENDPATH**/ ?>