								...
								<div class="card col-sm-12">
									...
									<div class="card-body">
										<form id="formNotasHis">
											<div class="col-sm-12">
												<textarea name="notas_historial"  rows="6" placeholder="Escribe aquí" id="" class="form-control" ><?php echo e($paciente->pluck('historial')[0][0]->notas_historial ?? ''); ?></textarea>
				...
				<div class="row">
					...
					<div class="col-sm-5 mb-3" >
						...
						<div class="form-group row">
							...
							<div class="col-sm-3 row" >
								<input type="number" value="<?php echo e($paciente->pluck('historial')[0][0]->estatura); ?>" class="form-control" id="estatura-signos2" name="estatura" placeholder="m" maxlength="3" min="100"  >
							</div>
						</div>
						<div class="form-group row">
							<div class="col-sm-9">
							...
							<div class="col-sm-3 row" >
								<input type="number" value="<?php echo e($paciente->pluck('historial')[0][0]->peso); ?>" class="form-control" id="peso-signos2" name="peso" placeholder="Kg" maxlength="3"  >
						...
						<div class="form-group row">
							...
							<div class="col-sm-3 row" >
								<input type="hidden" id="masa_corporal2" name="masa_corporal" value="<?php echo e($paciente->pluck('historial')[0][0]->masa_corporal ?? ''); ?>" >
