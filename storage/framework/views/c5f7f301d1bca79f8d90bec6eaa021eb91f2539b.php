							...
							<div class="profile-info-widget">
									<div class="col-sm-4">
										<a href="#" class="booking-doc-img">
											...
											<img width="30px" class="avatar-img" src="../storage/<?php echo e($paciente->pluck('foto')[0]); ?>" alt="<?php echo e($paciente->pluck('nombre')[0]); ?>">
											<?php else: ?>
									...
									<div class="col-sm-4" >
										<div class="">
											<div class="col-sm-12">
												<h3><?php echo e($paciente->pluck('nombre')[0]); ?> <?php echo e($paciente->pluck('apellido_p')[0]); ?> <?php echo e($paciente->pluck('apellido_m')[0]); ?> </h3><a href="" class="edit-link"><small><i class="fa fa-edit mr-1" ></i>Editar</small></a>
											</div>
											
											<span class="badge badge-primary" ><?php echo e($consulta_actual->pluck('motivo')[0]->motivo); ?> </span>
											<span class="badge badge-secondary" ><?php echo e($consulta_actual[0]->created_at); ?> </span>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\pixelar_doc\laravel-files\template\resources\views/doctors/consulta.blade.php ENDPATH**/ ?>