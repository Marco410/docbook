	...
	<div class="container-fluid">
		...
		<div class="row">
			...
			<div class="col-md-7 col-lg-8 col-xl-9">
				...
				<form method="post" enctype="multipart/form-data"  action="<?php echo e(route('doctor-paciente-registro')); ?>" class="needs-validation" novalidate>
					...
					<div class="card">
						<div class="card-body">
							...
							<div class="row form-row">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="text" name="apellido_m" class="form-control" value="<?php echo e(old("apellido_m")); ?>" >
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
								...
								<div class="col-md-2">
									<div class="form-group">
										<label>Sin correo
										<input type="checkbox" onclick="no_emailf(this)"  id="no_email" ></label>
										<script>
											function no_emailf(elemento){
												var emailInput = document.getElementById('email');
												if(elemento.checked){
													emailInput.disabled = true;
													emailInput.value = "Sin correo";
												}else{
													emailInput.value = "";
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="date" name="fecha_nacimiento" required class="form-control" value="<?php echo e(old("fecha_nacimiento")); ?>" >
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
								...
								<div class="col-md-4">
									<div class="form-group">
										...
										<input type="text" name="telefono" min="10" max="10" class="form-control" value="<?php echo e(old("telefono")); ?>" required >
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										<label>CURP </label>
										<input type="text" name="curp" class="form-control" value="<?php echo e(old("curp")); ?>">
									</div>
								</div>
								<div class="col-md-4">
									<div class="form-group">
										<label>Número de Seguro Social </label>
										<input type="text" name="seguro_social" class="form-control" value="<?php echo e(old("seguro_social")); ?>">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label>Nacionalidad </label>
										<input type="text" name="nacionalidad" class="form-control" value="<?php echo e(old("nacionalidad")); ?>">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label>Empleo </label>
										<input type="text" name="empleo" class="form-control" value="<?php echo e(old("empleo")); ?>">
									</div>
								</div>
							...
							<div class="row">
									...
									<div class="collapse" id="datos_demo">
										...
										<div class="col-md-5">
											<div class="form-group mb-3">
												<label>Calle </label>
												<input type="text" name="calle" required class="form-control" value="<?php echo e(old("calle")); ?>">
											</div>
										</div>
										<div class="col-md-5">
											<div class="form-group mb-0">
												<label>Colonia </label>
												<input type="text" name="colonia" required class="form-control" value="<?php echo e(old("colonia")); ?>">
											</div>
										</div>
										<div class="col-md-2">
										<div class="form-group mb-0">
												<label>Código Postal </label>
												<input type="text" name="cp" required class="form-control" value="<?php echo e(old("cp")); ?>">
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group mb-0">
												<label>Ciudad </label>
												<input type="text" name="ciudad" required class="form-control" value="<?php echo e(old("ciudad")); ?>">
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group mb-3">
								...
								<div class="col-sm-12">
									<h4 class="card-title">Familiar de Contacto</h4>
								</div>
								<div class="col-sm-6">
									<div class="form-group mb-3">
										<label>Nombre Completo </label>
										<input type="text" name="nombre_familiar" class="form-control" value="<?php echo e(old("nombre_familiar")); ?>">
									</div>
								</div>
								<div class="col-sm-6">
									<div class="form-group mb-3">
										<label>Teléfono </label>
										<input type="text" name="telefono_familiar" class="form-control" value="<?php echo e(old("telefono_familiar")); ?>">
									</div>
								</div>
							...
							<div class="col-sm-12">
								<div class="form-group mb-2">
									<div class="remember-me-col justify-content-between">
										...
										<label class="custom_check">
											<input required type="checkbox" class="" name="terminos"  value="1">
											<span class="checkmark"></span>
										</label>
										<span class="">El paciente acepta los <strong>terminos y condiciones</strong> de Docbook.</span>
									</div>
								</div>
							</div>
							</div>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\pixelar_doc\laravel-files\template\resources\views/doctors/doctor-patient-register.blade.php ENDPATH**/ ?>