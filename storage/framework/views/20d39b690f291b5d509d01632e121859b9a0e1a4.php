...
<?php $__env->startSection('content'); ?>	
            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="row">
						<div class="col-sm-12">
							<h4 class="text-center">Sin Especialidad</h4>
							<div class="card">
								<div class="card-body">
									<div class="table-responsive">
										<table class="datatable table table-hover table-center mb-0">
											...
											<tbody>
												...
												<?php $__currentLoopData = $doctorse; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doctor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
												<tr>
													<td>
														<h2 class="table-avatar">
															<a href="profile" class="avatar avatar-sm mr-2"><img class="avatar-img rounded-circle" src="../storage/<?php echo e($doctor->foto); ?>" alt="User Image"></a>
															<a href="<?php echo e(url('admin/perfil-doctor',['id'=>$doctor->id])); ?>">Dr. <?php echo e($doctor->nombre); ?> <?php echo e($doctor->apellido_p); ?></a>
														</h2>
													</td>
													<td><?php echo e($doctor->espe ?? ''); ?></td>
													<td><?php echo date("j M, Y", strtotime($doctor->created_at))  ?><br><small><?php echo date("h:i A", strtotime($doctor->created_at))  ?></small></td>
