									...
									<div class="row">
										...
										<div class="col-md-6">
											<p class="invoice-details">
												...
												<strong>Fecha de Realización:</strong> <?php echo e(date("d/m/Y h:i A")); ?>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="invoice-info">
												...
												<p class="invoice-details invoice-details-two">
													<strong>Dr. <?php echo e($doctor->nombre); ?> <?php echo e($doctor->apellido_p); ?> <?php echo e($doctor->apellido_m); ?></strong><br>
										...
										<div class="col-md-6">
											<div class="invoice-info invoice-info2">
												...
												<p class="invoice-details">
													<?php echo e($paciente->nombre); ?> <?php echo e($paciente->apellido_p); ?> <?php echo e($paciente->apellido_m); ?>
