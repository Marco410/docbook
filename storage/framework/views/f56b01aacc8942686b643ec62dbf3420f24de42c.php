...
<?php if(Auth::user()->hasPermissionTo('admin.index-admin') ): ?>				
					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-12">						
								...
								<h3 class="page-title">Bienvenido <strong><?php echo e(Auth::user()->nombre); ?></strong></h3>
								<ul class="breadcrumb">
...
<?php endif; ?>
<?php echo $__env->make('layout.mainlayout_admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\pixelar_doc\laravel-files\template\resources\views/admin/index_admin.blade.php ENDPATH**/ ?>