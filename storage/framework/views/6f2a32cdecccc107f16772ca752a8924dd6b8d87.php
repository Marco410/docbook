							...
							<div class="login-right">
								<div class="inner-right-login">
									<div class="login-header">
                                        ...
                                        <h3 class="text-center text-info" >Datos de tu Organización</h3>
										
                                        
										<form method="post" enctype="multipart/form-data" action="<?php echo e(route('guardar-clinica-nueva')); ?>" novalidate >
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\pixelar_doc\laravel-files\template\resources\views/doctors/new_clinic.blade.php ENDPATH**/ ?>