<meta charset="utf-8">
        ...
        <title>DocBook | Registro</title>
        <?php endif; ?>
        <?php if(Route::is(['index-admin'])): ?>
        <title>Inicio | Doccure</title>
        <?php endif; ?>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('main/izitoast/css/iziToast.min.css')); ?>">
	...
	<?php /**PATH D:\xampp\htdocs\pixelar_doc\laravel-files\template\resources\views/layout/partials/head_admin.blade.php ENDPATH**/ ?>