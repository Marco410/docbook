							...
							<div class="login-right">
								<div class="inner-right-login">
									<div class="login-header">
										...
										<form method="post" enctype="multipart/form-data"  action="<?php echo e(url('/pa-registro-paso4')); ?>" class="needs-validation" novalidate>
...
<?php echo $__env->make('layout.mainlayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\pixelar_doc\laravel-files\template\resources\views/pacients/patient-register-step4.blade.php ENDPATH**/ ?>