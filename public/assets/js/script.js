...
(function($) {
   ...
   $('.quantity-right-plus').click(function(e){
			...
			var scroll = $(window).scrollTop();
			  if (scroll > 95) {
				$(".header-trans").css("background" , "#FFFFFF");
				  ...
				  $(".header-trans").css("background" , "var(--sec)");  	
			  }
		  })
		})
	}
			...
			reader.onload = function (e) {
				switch (tipo) {
					case "profile_image":
					  ...
					  break;
					case "ine_front":
						$('#ine_front_img').attr('src', e.target.result);

						break;
					case "ine_back":
						$('#ine_back_img').attr('src', e.target.result);

						break;
					case "certificado_consultorio":
						$('#certificado_consultorio_img').attr('src', e.target.result);
	...
	$("#ine_front").change(function() {
		readURL(this,'ine_front');
	});

	$("#ine_back").change(function() {
		readURL(this,'ine_back');
	});

	$("#certificado_consultorio").change(function() {
		readURL(this,'certificado_consultorio');
	});
